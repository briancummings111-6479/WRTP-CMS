...
const DataExportPage: React.FC = () => {
  ...
  const convertToCSV = (clients: Client[]): string => {
    ...
    const flattenedData = clients.map(client => ({
        ...
        phone2: client.contactInfo.phone2,
        email: client.contactInfo.email,
        street: client.contactInfo.street,
        apt: client.contactInfo.apt,
        city: client.contactInfo.city,
        state: client.contactInfo.state,
        zip: client.contactInfo.zip,
        referralSource: client.referralSource,
        googleDriveLink: client.googleDriveLink,
        clientStatus: client.metadata.status,
        clientType: client.metadata.clientType,
        assignedCaseManager: client.metadata.assignedAdminName,
        initialAppointmentDate: new Date(client.metadata.initialAppointmentDate).toLocaleDateString(),
        applicationPacket: client.caseManagement.applicationPacket,
        idReceived: client.caseManagement.id,
        proofOfIncome: client.caseManagement.proofOfIncome,
        initialAssessment: client.caseManagement.initialAssessment,
        roi: client.caseManagement.roi,
        ispCompleted: client.caseManagement.ispCompleted,
        cpr: client.training.cpr,
        firstAid: client.training.firstAid,
        foodHandlersCard: client.training.foodHandlersCard,
        constructionCTE: client.training.constructionCTE,
        cosmetologyCTE: client.training.cosmetologyCTE,
        culinaryCTE: client.training.culinaryCTE,
        fireCTE: client.training.fireCTE,
        medicalCTE: client.training.medicalCTE,
    }));
